...
export const RESOURCES = {
  ...
  composite:     { id: 'composite',     name: 'Composite',     icon: '🪬',  color: '#86efac', refined: true },
...
export const BUILDINGS = {
  ...
  nano_forge: {
    ...
    levels: [
      {
        ...
        buildTime:   40,
        effect:      'Unlocks Nano Alloy & Composite conversion · uses 6 energy · 3 workers',
        production:  {},
        energyDrain: 6,
        staffDrain:  3,
      },
      ...
      },
      {
        ...
        buildTime:   80,
        effect:      '4× throughput · unlocks Composite→Nano Composite · uses 16 energy · 8 workers',
        production:  {},
        energyDrain: 16,
        staffDrain:  8,
      },
    ...
    conversions: [
      ...
      { input: { alloy: 10, crystal: 15 }, output: { composite:  1 }, durationBase: 25 },
    ],
  },
  ...
  obsidian_foundry: {
    ...
    levels: [
      {
        ...
        buildTime:   40,
        effect:      'Unlocks Hardened Steel & Lava Gem conversion · uses 6 energy · 3 workers',
        production:  {},
        energyDrain: 6,
        staffDrain:  3,
      },
      ...
      },
      {
        ...
        buildTime:   80,
        effect:      '4× throughput · unlocks Lava Gem→Plasma Core · uses 16 energy · 8 workers',
        production:  {},
        energyDrain: 16,
        staffDrain:  8,
      },
    ...
    conversions: [
      { input: { obsidian: 10, metal:   15 }, output: { hardened_steel: 1 }, durationBase: 20 },
      { input: { obsidian:  8, crystal: 12 }, output: { lava_gem:       1 }, durationBase: 30 },
    ],
  },
  ...
  bio_lab: {
    ...
    levels: [
      {
        ...
        buildTime:   40,
        effect:      'Unlocks Bio Polymer & Coral Steel conversion · uses 6 energy · 3 workers',
        production:  {},
        energyDrain: 6,
        staffDrain:  3,
      },
      ...
      },
      {
        ...
        buildTime:   80,
        effect:      '4× throughput · unlocks Bio Polymer→Neural Fiber · uses 16 energy · 8 workers',
        production:  {},
        energyDrain: 16,
        staffDrain:  8,
      },
    ...
    conversions: [
      { input: { biomass: 10, crystal: 10 }, output: { bio_polymer:  1 }, durationBase: 20 },
      { input: { biomass: 15, metal:   10 }, output: { coral_steel:  1 }, durationBase: 25 },
    ],
  },
