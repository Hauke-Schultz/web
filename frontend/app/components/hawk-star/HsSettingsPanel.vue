...
const PLANET_CHEATS  = ['complete_buildings', 'complete_units', 'complete_conversions', 'max_resources', 'drain_battery', 'drain_shield', 'add_population', 'roll_anomaly', 'spy_on_me', 'grant_find']
...
<template>
  <div class="hs-settings-panel">
    <div class="hs-dev-panel">
      ...
      <button class="hs-cheat-btn" :disabled="cheatBusy" title="+500 Bergungsschrott und Laderaum voll — die Schmelze sonst zu testen heißt stundenlang angeln" @click="runCheat('fill_salvage')">🔩 +500</button>
      <button class="hs-cheat-btn" :disabled="cheatBusy" title="Nächstes Fundstück aus dem Katalog vergeben — bei 1,5 % pro Fang sonst nicht testbar" @click="runCheat('grant_find')">✨ Fundstück</button>
